					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<li class="nav-item dropdown hidden-caret">
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
								<div class="avatar-sm">
									<img src="<?=asset('assets/img/user-placeholder.png')?>" alt="..." class="avatar-img rounded-circle" style="object-position: top;">
								</div>
							</a>
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<?=asset('assets/img/user-placeholder.png')?>" alt="image profile" class="avatar-img rounded" style="object-position: top;"></div>
											<div class="u-text">
